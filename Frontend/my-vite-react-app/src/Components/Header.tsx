      ...
      <div className="container">
        ...
        <nav>
          <ul className="nav-list">
            ...
            <li>
              <Link to="/products" className="nav-link cart-icon">
